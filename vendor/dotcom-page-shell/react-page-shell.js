...
var shellStyles = {
  ...
  popoverContainer:
    'shell-absolute shell-w-full shell-z2 shell-disable-text-size-adjust',
  popoverBody: 'shell-shadow-darken10-bold shell-bg-white',
  popoverTriangle:
    'shell-triangle-wide shell-triangle-wide--u shell-color-white shell-z5',

  popoverNavHeading:
    'shell-txt-uppercase shell-txt-s shell-txt-spacing1 shell-txt-fancy shell-color-darken50',

  // Left blue highlight section
  popoverNavLinkHighlight:
    'shell-inline-block shell-color-blue shell-color-gray-dark-on-hover shell-txt-s shell-txt-bold',

  // Right navigation, use menu, footer links seciton
  popoverNavLink:
    'shell-inline-block shell-color-gray-dark shell-color-blue-on-hover',
  popoverNavLinkDescription:
    'shell-inline-block shell-color-darken50 shell-txt-s',

  // User menu popovers
  userNavLink:
    'shell-align-middle shell-color-gray-dark shell-color-blue-on-hover shell-txt-s shell-mx12 shell-mx12-ml shell-mx24-mxl shell-my12',
  userAvatar:
...
var NavigationHighlightLink = (function(_React$Component) {
  ...
  function NavigationHighlightLink() {
    ...
    return possibleConstructorReturn(
      this,
      (NavigationHighlightLink.__proto__ ||
        Object.getPrototypeOf(NavigationHighlightLink))
        .apply(this, arguments)
    );
  }
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('use', {
                  xlinkHref: '#shell-icon-chevron-right'
                })
              )
            )
          )
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              {
                ...
                className:
                  shellStyles.popoverContainer +
                  ' shell-align-center shell-animated-menu',
                style: {
                  right: 0,
                  top: '100%',
                  marginTop: '14px'
              ...
              React.createElement('div', {
                ...
                className:
                  shellStyles.popoverTriangle + ' shell-animated-menu__pointer',
                style: {
                  position: 'absolute',
                  top: 0
                }
...
var NavigationItem = (function(_React$Component) {
  ...
  function NavigationItem() {
    ...
    return possibleConstructorReturn(
      this,
      (NavigationItem.__proto__ || Object.getPrototypeOf(NavigationItem))
        .apply(this, arguments)
    );
  }
  ...
  createClass(NavigationItem, [
    ...
    },
    {
      key: 'render',
      value: function render() {
        var colorBasedClasses = this.props.darkText
        ...
        return React.createElement(
          ...
          {
            className:
              'shell-flex-child shell-mx6 shell-mx12-ml shell-mx18-mxl',
            style: { lineHeight: 1 }
          },
          React.createElement(
            'a',
            {
              className:
                'shell-py6 shell-txt-s shell-txt-bold ' + colorBasedClasses,
...
var NavigationItemWithMenu = (function(_React$PureComponent) {
  ...
  function NavigationItemWithMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (NavigationItemWithMenu.__proto__ ||
        Object.getPrototypeOf(NavigationItemWithMenu))
        .apply(this, arguments)
    );
  }
  ...
  createClass(NavigationItemWithMenu, [
    {
      ...
      value: function render() {
        ...
        menuNameClasses += this.props.darkText
          ? ' shell-navigation-menu-button shell-transition shell-color-gray-dark shell-color-blue-on-hover'
          : ' shell-navigation-menu-button shell-link shell-link--white';
...
var HowMapboxWorksImg = (function(_React$Component) {
  ...
  function HowMapboxWorksImg() {
    ...
    return possibleConstructorReturn(
      this,
      (HowMapboxWorksImg.__proto__ || Object.getPrototypeOf(HowMapboxWorksImg))
        .apply(this, arguments)
    );
  }
      ...
      value: function render() {
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('path', {
              d:
                'M26.87 22.78a3 3 0 0 0-3.1-3 3 3 0 0 0-2.93 3.11 3 3 0 0 0 1.88 2.69l.89 1.54a.3.3 0 0 0 .52 0l.9-1.56a3 3 0 0 0 1.84-2.78z',
              fill: '#fff'
            }),
            ...
            React.createElement('path', {
              d:
                'M29.27 41.65A2.57 2.57 0 0 0 26 39.19a3.18 3.18 0 0 0-5.53.64 2.2 2.2 0 0 0 .25 4.39h6.12a2.57 2.57 0 0 0 2.43-2.57z',
              fill: '#fff'
            }),
            React.createElement('path', {
              d:
                'M25.92 41.6L24 39.22a.38.38 0 0 0-.58 0l-1.95 2.38a.38.38 0 0 0 .29.61h1.09v2h1.67v-2h1.1a.38.38 0 0 0 .3-.61z',
              fill: '#62baed'
            }),
            React.createElement('path', {
              d:
                'M91.83 13.74H69.06a1.68 1.68 0 0 0-1.68 1.68v17.07a1.68 1.68 0 0 0 1.68 1.68h10.89v7.61a4.69 4.69 0 0 1-.83 3 2 2 0 0 1-1.52.59H61v2h16.6a4 4 0 0 0 3-1.22 6.52 6.52 0 0 0 1.36-4.47v-7.51h9.88a1.68 1.68 0 0 0 1.68-1.68V15.42a1.68 1.68 0 0 0-1.69-1.68z',
              fill: '#1078bf'
            }),
            ...
            React.createElement('path', {
              fill: '#fff',
              d: 'M39.26 15.75h18.76v32.16H39.26z'
            }),
            React.createElement('path', {
              d:
                'M49 47.91h-2V27.48a5.49 5.49 0 0 1 1.27-3.72 4.35 4.35 0 0 1 3.32-1.3H58v2h-6.45a2.41 2.41 0 0 0-1.86.67 3.5 3.5 0 0 0-.69 2.28z',
              fill: '#1078bf'
            }),
            React.createElement('circle', {
              cx: '47.97',
            ...
            React.createElement('path', {
              d:
                'M47.65 32.8l-1.22 2.44a.27.27 0 0 0 .4.35l1-.73 1.26.81a.27.27 0 0 0 .39-.35l-1.2-2.52a.35.35 0 0 0-.63 0z',
              fill: '#fff'
            }),
            React.createElement('path', {
            ...
            React.createElement('path', {
              d:
                'M71.4 20.52a.75.75 0 0 1-.5-1.3l.71-.64-.69-.58a.75.75 0 0 1 1-1.15l1.3 1.15a.75.75 0 0 1 0 1.13l-1.34 1.22a.74.74 0 0 1-.48.17z',
              fill: '#fff'
            }),
            React.createElement('path', {
              d:
                'M80.78 27.89H71.4a.75.75 0 0 1 0-1.5h9.38a.75.75 0 0 1 0 1.5zM90.83 27.89h-6.7a.75.75 0 0 1 0-1.5h6.7a.75.75 0 0 1 0 1.5zM86.48 31.24H71.4a.75.75 0 0 1 0-1.5h15.08a.75.75 0 0 1 0 1.5zM85.47 24.54H71.4a.75.75 0 0 1 0-1.5h14.07a.75.75 0 0 1 0 1.5z',
              fill: '#62baed'
            })
          )
        );
...
var TutorialsImg = (function(_React$Component) {
  ...
  function TutorialsImg() {
    ...
    return possibleConstructorReturn(
      this,
      (TutorialsImg.__proto__ || Object.getPrototypeOf(TutorialsImg))
        .apply(this, arguments)
    );
  }
      ...
      value: function render() {
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('path', {
              d:
                'M24.57 17.68h-4.2a2.1 2.1 0 0 0-2.09 2.1v2.79h8.38v-2.79a2.1 2.1 0 0 0-2.09-2.1zM57.12 44.23H38a4.83 4.83 0 0 0-4.76 3.84 4.54 4.54 0 0 0-.08.65 4.72 4.72 0 0 0 4.71 4.94h19.78a4.19 4.19 0 0 0 4.19-4.19v-10a4.71 4.71 0 0 1-4.72 4.76z',
              fill: '#269561'
            }),
            React.createElement('rect', {
              x: '38.44',
            ...
            React.createElement('path', {
              d:
                'M57.12 44.23a4.71 4.71 0 0 0 4.71-4.71V13.46A3.46 3.46 0 0 0 58.38 10H36.66a3.46 3.46 0 0 0-3.46 3.46v34.61h.09A4.83 4.83 0 0 1 38 44.23z',
              fill: '#fcfcfc'
            }),
            React.createElement('path', {
              d:
                'M43.51 55.85L40.88 54l-3 1.91a.55.55 0 0 1-.84-.46v-5a1.66 1.66 0 0 1 1.66-1.66h4a1.66 1.66 0 0 1 1.66 1.66v5a.55.55 0 0 1-.85.4z',
              fill: '#afdec5'
            }),
            React.createElement('rect', {
              x: '37.39',
            ...
            React.createElement('path', {
              d:
                'M52.41 18.78H41.23a.75.75 0 0 1 0-1.5h11.18a.75.75 0 0 1 0 1.5zM47.17 21.93h-5.94a.75.75 0 0 1 0-1.5h5.94a.75.75 0 0 1 0 1.5z',
              fill: '#f7f8f9'
            }),
            React.createElement('path', {
              d:
                'M26.66 48.07l-1.5-1a.71.71 0 0 0-.93 0l-1.19 1a.64.64 0 0 1-.81 0L20.87 47a.71.71 0 0 0-.87 0l-1.7 1V22.57h8.38z',
              fill: '#afdec5'
            }),
            React.createElement('path', {
              d:
                'M24.23 47.07l-1.19 1a.64.64 0 0 1-.81 0L20.87 47a.71.71 0 0 0-.87 0l-1.7 1v.18a1.49 1.49 0 0 0 .33.93l3.37 4.3a.61.61 0 0 0 1 0l3.39-4.23a1.49 1.49 0 0 0 .33-.93v-.18l-1.5-1a.71.71 0 0 0-.99 0z',
              fill: '#fff'
            }),
            React.createElement('path', {
              d:
                'M26.34 49.17l-3.39 4.23a.61.61 0 0 1-1 0l-3.35-4.23a1.49 1.49 0 0 1-.33-.93v-4h8.38v4a1.49 1.49 0 0 1-.31.93z',
              fill: '#fcfcfc'
            }),
            React.createElement('path', {
              d:
                'M22.47 51.56a3.47 3.47 0 0 0-1.63.41L22 53.41a.61.61 0 0 0 1 0L24.1 52a3.47 3.47 0 0 0-1.63-.44z',
              fill: '#269561'
            }),
            React.createElement('rect', {
              x: '70.42',
            ...
            React.createElement('path', {
              fill: '#afdec5',
              d: 'M73.73 21.53H88.4v23.05H73.73z'
            })
          )
        );
      }
...
var PopoverWrapper = (function(_React$Component) {
  ...
  function PopoverWrapper() {
    ...
    return possibleConstructorReturn(
      this,
      (PopoverWrapper.__proto__ || Object.getPrototypeOf(PopoverWrapper))
        .apply(this, arguments)
    );
  }
      ...
      value: function render() {
        return React.createElement(
          'div',
          {
            ...
            className:
              shellStyles.popoverContainer +
              ' shell-w-full shell-left shell-animated-menu',
            style: {
              top: '100%',
              marginTop: '14px'
            }
...
var PopoverContentProducts = (function(_React$Component) {
  ...
  function PopoverContentProducts() {
    ...
    return possibleConstructorReturn(
      this,
      (PopoverContentProducts.__proto__ ||
        Object.getPrototypeOf(PopoverContentProducts))
        .apply(this, arguments)
    );
  }
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              {
                className:
                  'shell-col shell-col--offl1 shell-col--10 shell-col--offr1 shell-py30'
              },
              React.createElement(
                'div',
                {
                  className:
                    shellStyles.popoverNavHeading +
                    ' shell-pb6 shell-border-b shell-border--gray-light'
                },
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  {
                    className:
                      'shell-col shell-col--3 shell-col--2-mxl shell-mt18'
                  },
                  navigationMenuData.headerMainMenus.products.highlightedLinks.map(
                    function(highlightedLink, i) {
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        'shell-grid shell-grid--gut12 shell-grid--gut18-ml shell-grid--gut24-mxl'
                    },
                    navigationMenuData.headerMainMenus.products.links.map(
                      function(link, i) {
                        return React.createElement(
                          'li',
                          {
                            className:
                              'shell-col shell-col--4 shell-col--3-mxl',
                            key: i,
                            style: { lineHeight: 1 }
                          },
                          React.createElement(
                            ...
                            {
                              className:
                                'shell-link shell-color-gray-dark shell-color-blue-on-hover',
                              href: link.to,
                              'data-nav-link': true,
                            ...
                            React.createElement(
                              ...
                              {
                                className:
                                  'shell-txt-bold shell-txt-s shell-mb3 shell-mt18'
                              },
                              link.name
                            ),
                            React.createElement(
                              ...
                              {
                                className:
                                  'shell-color-darken50 shell-txt-s shell-my0'
                              },
                              link.description
                            )
                          )
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  navigationMenuData.useCaseMenu.highlightedLinks.map(function(
                    highlightedLink,
                    i
                  ) {
                    if (highlightedLink.hideInHeader) return;
                    return React.createElement(
                      ...
                      React.createElement(
                        'a',
                        {
                          href: highlightedLink.to,
                          className:
                            shellStyles.popoverNavLinkHighlight +
                            ' shell-mb3 shell-pr6',
                          'data-nav-link': highlightedLink.name,
                          'data-test': 'nav-link-' + highlightedLink.name
                        },
...
var PopoverSectionSecondary = (function(_React$Component) {
  ...
  function PopoverSectionSecondary() {
    ...
    return possibleConstructorReturn(
      this,
      (PopoverSectionSecondary.__proto__ ||
        Object.getPrototypeOf(PopoverSectionSecondary))
        .apply(this, arguments)
    );
  }
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              navigationMenuData[this.props.id].highlightedLinks.map(function(
                highlightedLink,
                i
              ) {
                if (highlightedLink.hideInHeader) return;
                  ...
                  return React.createElement(
                    ...
                    React.createElement(
                      'a',
                      {
                        href: link.to,
                        className:
                          'shell-grid shell-grid--gut12 shell-grid--gut18-ml shell-grid--gut24-mxl shell-link shell-color-gray-dark shell-color-blue-on-hover',
                        'data-nav-link': true,
                        'data-test': 'nav-link-' + link.name
                      },
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          {
                            className:
                              link.displayBackgroundColor +
                              ' shell-relative shell-illustration-container'
                          },
                          React.createElement(link.displayImage, {
                            className:
                              'shell-flex-child shell-absolute shell-w-full shell-h-full'
                          })
                        )
                      ),
                      React.createElement(
...
var PopoverContentDocumentation = (function(_React$Component) {
  ...
  function PopoverContentDocumentation() {
    ...
    return possibleConstructorReturn(
      this,
      (PopoverContentDocumentation.__proto__ ||
        Object.getPrototypeOf(PopoverContentDocumentation))
        .apply(this, arguments)
    );
  }
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    navigationMenuData.sdkDocumentationMenu.links.map(function(
                      link,
                      i
                    ) {
                      return React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            {
                              className:
                                shellStyles.popoverNavLink +
                                ' shell-txt-bold shell-txt-s shell-mt18 shell-mb0'
                            },
                            link.name
                          )
                        )
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'ul',
                    { className: 'shell-grid shell-grid--gut12' },
                    navigationMenuData.apiDocumentationMenu.links.map(function(
                      link,
                      i
                    ) {
                      return React.createElement(
                ...
                React.createElement(
                  ...
                  navigationMenuData.headerMainMenus.documentation.highlightedLinks.map(
                    function(highlightedLink, i) {
                      if (highlightedLink.hideInHeader) return;
                      return React.createElement(
                        'li',
...
var MobileMenuButton = (function(_React$Component) {
  ...
  function MobileMenuButton() {
    ...
    return possibleConstructorReturn(
      this,
      (MobileMenuButton.__proto__ || Object.getPrototypeOf(MobileMenuButton))
        .apply(this, arguments)
    );
  }
...
var NavigationDividedLinkList = (function(_React$Component) {
  ...
  function NavigationDividedLinkList() {
    ...
    return possibleConstructorReturn(
      this,
      (NavigationDividedLinkList.__proto__ ||
        Object.getPrototypeOf(NavigationDividedLinkList))
        .apply(this, arguments)
    );
  }
  ...
  createClass(NavigationDividedLinkList, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var linkFontSize =
          this.props.navigationType === 'mobile-navigation'
            ? 'shell-txt-m'
            : 'shell-txt-s';
        ...
        var showNavHeading = this.props.name
          ? React.createElement(
              'div',
          ...
          : '';
        return React.createElement('div', null, showNavHeading, items);
      }
    }
  ]);
...
var NavigationLinkList = (function(_React$Component) {
  ...
  function NavigationLinkList() {
    ...
    return possibleConstructorReturn(
      this,
      (NavigationLinkList.__proto__ ||
        Object.getPrototypeOf(NavigationLinkList))
        .apply(this, arguments)
    );
  }
  ...
  createClass(NavigationLinkList, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        // Font size is larger for items with a heading in mobile
        var linkFontSize =
          this.props.name && this.props.navigationType === 'mobile-navigation'
            ? 'shell-txt-l'
            : 'shell-txt-m';

        // Special case: the custom combination menu doesn't need a heading
        var navigationHeading = this.props.name
          ? React.createElement(
              'div',
              { className: shellStyles.popoverNavHeading },
              this.props.name
            ...
            return React.createElement(
              ...
              React.createElement(
                'a',
                {
                  ...
                  'data-nav-link': true,
                  'data-test':
                    _this2.props.navigationType + '-link-' + link.name
                },
                React.createElement(
                  'p',
                  {
...
var MobileUserMenu = (function(_React$Component) {
  ...
  function MobileUserMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (MobileUserMenu.__proto__ || Object.getPrototypeOf(MobileUserMenu))
        .apply(this, arguments)
    );
  }
      ...
      value: function render() {
        return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'a',
                  {
                    ...
                    className:
                      shellStyles.popoverNavLink +
                      ' shell-txt-m shell-mb0 shell-mt12'
                  },
                  'Account'
                )
              ),
          ...
          React.createElement(
            'div',
            {
              'data-display-block-unauthenticated': true,
              style: { display: 'none' }
            },
            React.createElement(
              'a',
              {
                href: '/signin/',
                className:
                  shellStyles.popoverNavLink + ' shell-txt-m shell-w-full',
    ...
    },
    {
      ...
      value: function render() {
        return React.createElement(
          ...
          {
            className:
              'shell-mr-neg6 shell-flex-child shell-flex-parent shell-flex-parent--end-main shell-z1 shell-absolute shell-top shell-left shell-w-full'
          },
          React.createElement('div', {
          ...
          React.createElement(
            'div',
            {
              ...
              className:
                shellStyles.mobilePopoverContainer +
                ' shell-w-full shell-animated-menu',
              style: {
                top: 0,
                right: 0
              }
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  NavigationLinkList,
                  _extends({}, navigationMenuData.headerMainMenus.products, {
                    navigationType: 'mobile-navigation'
                  })
                ),
                React.createElement(
                  NavigationLinkList,
                  _extends({}, navigationMenuData.useCaseMenu, {
                    navigationType: 'mobile-navigation'
                  })
                )
              ),
              React.createElement(
                ...
                React.createElement('div', {
                  className:
                    'shell-border-t shell-border--gray-light shell-absolute shell-top shell-left shell-right'
                }),
                React.createElement(
                  NavigationDividedLinkList,
                  _extends({}, navigationMenuData.mobileCombinationMenu, {
                    navigationType: 'mobile-navigation'
                  })
                )
              ),
              React.createElement(MobileUserMenu, {
                className:
                  'shell-bg-gray-faint shell-py24 shell-px24 shell-mr-neg24 shell-ml-neg24'
              })
            )
          )
        );
      ...
      value: function render() {
        ...
        if (!this.props.darkText) {
          ...
          logoOverlay = React.createElement('a', {
            className:
              'shell-mb-logo shell-mobile-nav__logo--overlay shell-absolute shell-top shell-left',
            href: '/',
            'aria-label': 'Mapbox'
          });
        }
        ...
        var documentationTriggerIDAuthenticated =
          documentationTriggerID + '-authenticated';
        ...
        return React.createElement(
          ...
          React.createElement(
            'div',
            {
              ...
              className:
                'shell-none-mm limiter shell-py12 shell-flex-parent shell-flex-parent--center-cross shell-flex-parent--space-between-main shell-relative shell-z2'
            },
            React.createElement(
              'div',
              {
                className:
                  'shell-mb-logo__wrapper shell-flex-child shell-relative'
              },
              React.createElement('a', {
          ...
          React.createElement(PopoverContentDocumentation, {
            ...
            name: 'Documentation',
            triggerID:
              documentationTriggerID +
              ' ' +
              documentationTriggerIDAuthenticated,
...
var FooterLegalStrip = (function(_React$Component) {
  ...
  function FooterLegalStrip() {
    ...
    return possibleConstructorReturn(
      this,
      (FooterLegalStrip.__proto__ || Object.getPrototypeOf(FooterLegalStrip))
        .apply(this, arguments)
    );
  }
      ...
      value: function render() {
        return React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                'shell-link shell-color-darken50 shell-color-blue-on-hover shell-mr18',
              href: '/tos/'
            },
            'Terms'
          ),
          ...
          React.createElement(
            ...
            {
              className:
                'shell-link shell-color-darken50 shell-color-blue-on-hover',
...
var FooterSocialMediaStrip = (function(_React$Component) {
  ...
  function FooterSocialMediaStrip() {
    ...
    return possibleConstructorReturn(
      this,
      (FooterSocialMediaStrip.__proto__ ||
        Object.getPrototypeOf(FooterSocialMediaStrip))
        .apply(this, arguments)
    );
  }
        ...
        return React.createElement(
          ...
          React.createElement(
            'a',
            {
              'aria-label': 'Twitter',
              className:
                'shell-mr18 shell-color-blue shell-color-gray-dark-on-hover',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('path', {
                  d:
                    'M36.84,13.16c-7.34,0-8.61,2.68-9.21,5.26V13.16H17.11V50H27.63V28.95c0-3.41,1.85-5.26,5.26-5.26s5.26,1.81,5.26,5.26V50H48.68V31.58C48.68,21.05,47.31,13.16,36.84,13.16Z'
                }),
                React.createElement('circle', {
                  cx: '6.58',
                  cy: '5.26',
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('path', {
                  ...
                  'data-name': 'f',
                  d:
                    'M28.87,50V27.19h7.65l1.15-8.89h-8.8V12.63c0-2.57.71-4.33,4.41-4.33H38v-8A63.78,63.78,0,0,0,31.13,0C24.34,0,19.69,4.14,19.69,11.75V18.3H12v8.89h7.68V50Z'
                })
              )
            )
          ),
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('path', {
                  d:
                    'M25,33.33A8.33,8.33,0,1,1,33.33,25,8.33,8.33,0,0,1,25,33.33Zm0-21.17A12.84,12.84,0,1,0,37.84,25,12.84,12.84,0,0,0,25,12.16Z'
                }),
                React.createElement('path', {
    ...
    },
    {
      ...
      value: function render() {
        ...
        var renderMenuLinks = function renderMenuLinks(menuData) {
          ...
          var linkClasses =
            'shell-txt-s shell-color-gray-dark shell-color-blue-on-hover shell-mt6';
          ...
          if (menuData.highlightedLinks) {
            highlightedLinkEls = menuData.highlightedLinks.map(function(link) {
              ...
              var isBold =
                link.name === 'API Documentation' ? '' : 'shell-txt-bold';
              return React.createElement(
                'div',
                { className: linkClasses, key: link.name },
                React.createElement(
        ...
        var columnClassList =
          'shell-footer-column shell-flex-child shell-mt24 shell-mt0-mm';
        return React.createElement(
          'footer',
          {
            id: 'page-footer',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              footerColumnItemsIds.map(function(columnId, i) {
                ...
                if (i === footerColumnItemsIds.length - 1)
                  columnClasses += ' mb0-mm mb24';
                var columnData =
                  columnId in navigationMenuData.headerMainMenus
                    ? navigationMenuData.headerMainMenus[columnId]
                    : navigationMenuData[columnId];
                return React.createElement(
                  'div',
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        shellStyles.popoverNavHeading + ' shell-mb3 shell-pr12'
                    },
                    columnData.name
                  ),
                  React.createElement(
            ...
            React.createElement(
              'div',
              {
                ...
                className:
                  'shell-grid shell-txt-s shell-color-darken50 shell-py12 shell-py0-ml shell-mt42-ml'
              },
              ...
              React.createElement(FooterSocialMediaStrip, {
                className:
                  'shell-col shell-col--12 shell-col--6-mm shell-my12 shell-footer-fr'
              })
            )
          ),
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('path', {
                d:
                  'M7.5 13.105a.806.806 0 0 1-.537-1.407l3.055-2.724-3.08-2.997a.806.806 0 1 1 1.124-1.155l3.7 3.6a.805.805 0 0 1-.025 1.18l-3.7 3.3a.803.803 0 0 1-.537.204z'
              })
            )
          )
        );
