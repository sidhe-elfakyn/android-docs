/* SDK Versions */
export const JAVA_SDK_VERSION = '3.3.0';
export const MAP_SDK_VERSION = '6.1.3';
export const NAVIGATION_VERSION = '0.14.0';
...
export const LOCATION_LAYER_PLUGIN_VERSION = '0.5.3';
...
export const CHINA_PLUGIN_VERSION = '0.4.3';
